          ...
          <div className="flex flex-col lg:flex-row items-start lg:items-center gap-4">
            ...
            <div className="flex items-start gap-3 flex-1">
              ...
              <div className="flex-1">
                <h3 className="font-bold text-gray-900 mb-1">Utilizamos cookies</h3>
                <p className="text-sm text-gray-700 leading-relaxed">
                  Utilizamos cookies para melhorar a sua experiência no nosso site e para lhe mostrar publicidade
                  relevante. Ao continuar a navegar, aceita a nossa utilização de cookies.{" "}
